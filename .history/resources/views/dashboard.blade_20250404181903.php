    ...
    <header class="bg-white shadow-md">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6">
                <div class="text-gray-700 hover:text-indigo-600 transition duration-300 cursor-pointer">
        ...
        <div id="mobile-menu" class="md:hidden hidden px-4 py-3 bg-gray-50 border-t">
            <div class="block py-2 text-gray-700 hover:text-indigo-600 cursor-pointer">
                <i class="fas fa-briefcase mr-1"></i> Projects
            </div>
            <div class="block py-2 text-gray-700 hover:text-indigo-600 cursor-pointer">
                <i class="fas fa-plus-circle mr-1"></i> Post Project
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="col-span-1">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="mt-4">
                        <div class="block w-full py-2 px-4 bg-indigo-50 text-indigo-600 text-center rounded hover:bg-indigo-100 transition duration-300 cursor-pointer">
                            Edit Profile
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-1 lg:col-span-3">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="text-indigo-600 hover:text-indigo-800 cursor-pointer">View All</div>
                    </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-4 mt-4 md:mt-0">
                    <div class="text-gray-500 hover:text-indigo-600 cursor-pointer"><i class="fab fa-twitter"></i></div>
                    <div class="text-gray-500 hover:text-indigo-600 cursor-pointer"><i class="fab fa-github"></i></div>
                    <div class="text-gray-500 hover:text-indigo-600 cursor-pointer"><i class="fab fa-linkedin"></i></div>
                </div>
            </div>
        </div>
    </footer>
                                ...
                                projects.map(project => (
                                    <tr key={project.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <span className="text-indigo-600 hover:text-indigo-900 mr-3 cursor-pointer">View</span>
