...
<body class="bg-black text-white">
    ...
    <!-- Main Content -->
    <main class="min-h-screen py-6 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-600">
        @yield('content')
    </main>

    <main class="main">
        <div class="content">
            <h1>Three.js Animated Background</h1>
            <p>This is your content area. The background is powered by Three.js with animated particles.</p>
        </div>
    </main>
