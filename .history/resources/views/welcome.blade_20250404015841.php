...
<script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
  ...
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Kobar - Platform for Programmers and Freelancers</title>
          ...
          <div className="relative z-10">
            ...
            <nav className="px-6 py-4 flex justify-between items-center">
              ...
              <div className="hidden md:flex space-x-8">
                ...
                <a href="#" className="text-gray-300 hover:text-blue-300 transition">Login</a>
                <a href="#" className="text-gray-300 hover:text-blue-300 transition">Register</a>
              </div>
            </nav>
            ...
            {showMenu && (
              <div className="md:hidden bg-gray-800 glass-card mt-2 rounded-lg p-4 mx-4">
                ...
                <a href="#" className="block py-2 text-gray-300 hover:text-blue-300">Login</a>
                <a href="#" className="block py-2 text-gray-300 hover:text-blue-300">Register</a>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  <div>
                    ...
                    <p className="text-gray-400">
                      Connecting talent and opportunities in a decentralized marketplace.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                      ...
                      <li><a href="#" className="hover:text-blue-300">UI/UX Design</a></li>
                    </ul>
                  </div>
