...
<div className="px-6 py-16 max-w-4xl mx-auto text-center">
  <div className="glass-card rounded-xl p-8 md:p-12">
    <h2 className="text-3xl font-bold text-blue-100 mb-6">Join Kobar Team</h2>
    <p className="text-xl text-gray-300 mb-8">
      Be part of Kobar Team, our dedicated development team building amazing solutions.
    </p>
    ...
    <p className="text-gray-400 mt-6">
      Already a member?{" "}
      <a href="/dashboard" className="text-blue-400 hover:text-blue-300 font-semibold">
        Go to Dashboard
      </a>
    </p>
  </div>
