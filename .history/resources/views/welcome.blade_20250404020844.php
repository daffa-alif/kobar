...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 px-6 py-4 z-50 transition-all ${
    ...
    >
      ...
      {/* Mobile menu */}
      <div
        className={`md:hidden bg-gray-800 glass-card rounded-lg mx-4 p-4 mt-2 transition-all duration-300 ease-in-out ${
          showMenu ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"
        }`}
      >
        <a href="#" className="block py-2 text-blue-300 hover:text-blue-100" onClick={closeMenu}>Home</a>
        <a href="#" className="block py-2 text-gray-300 hover:text-blue-300" onClick={closeMenu}>Services</a>
        <a href="#" className="block py-2 text-gray-300 hover:text-blue-300" onClick={closeMenu}>About</a>
        <a href="#" className="block py-2 text-gray-300 hover:text-blue-300" onClick={closeMenu}>Projects</a>
        <a href="#" className="block py-2 text-gray-300 hover:text-blue-300" onClick={closeMenu}>Contact</a>
      </div>
    </nav>
  );
}
