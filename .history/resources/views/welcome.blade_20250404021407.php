...
<nav class="px-6 py-4 flex justify-between items-center">
  <div class="flex items-center">
    ...
    <span class="ml-3 text-2xl font-bold text-blue-400">KOBAR.CO.ID</span>
  </div>
...
<!-- Mobile menu -->
<div id="mobile-menu" class="md:hidden bg-gray-800 glass-card mt-2 rounded-lg p-4 mx-4 hidden opacity-0 scale-95 transition-all duration-300 ease-in-out">
  <a href="#" class="block py-2 text-blue-300 hover:text-blue-100">Home</a>
  <a href="#" class="block py-2 text-gray-300 hover:text-blue-300">Services</a>
  <a href="#" class="block py-2 text-gray-300 hover:text-blue-300">About</a>
  <a href="#" class="block py-2 text-gray-300 hover:text-blue-300">Projects</a>
  <a href="#" class="block py-2 text-gray-300 hover:text-blue-300">Contact</a>
</div>
...
<script>
  ...
  // Toggle mobile menu visibility and icons
