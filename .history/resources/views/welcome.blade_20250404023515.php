...
const EnhancedNavbar = () => {
  ...
  return (
    <>
      <nav className={`px-6 py-4 flex justify-between items-center sticky top-0 transition-all duration-300 z-50 ${
        ...
        <div className="md:hidden">
          <button 
            onClick={toggleMenu}
            className="text-gray-300 hover:text-white focus:outline-none relative overflow-hidden group p-2 rounded-lg transition-all duration-300 hover:bg-blue-500/20"
          >
            <span className="absolute w-0 h-0 transition-all duration-300 ease-out bg-blue-500 rounded-full group-hover:w-full group-hover:h-full opacity-10"></span>
        ...
        <div className="hidden md:flex space-x-8">
          <a href="#" className="text-blue-300 hover:text-blue-100 transition relative group">
            Home
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#" className="text-gray-300 hover:text-blue-300 transition relative group">
            Services
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#" className="text-gray-300 hover:text-blue-300 transition relative group">
      ...
      {/* Mobile menu */}
      <div 
        className={`md:hidden fixed top-[72px] left-0 right-0 bg-gray-800/90 backdrop-blur-md p-4 mx-4 rounded-lg shadow-lg transform transition-all duration-300 ease-in-out ${
          showMenu ? 'opacity-100 translate-y-0 z-40' : 'opacity-0 -translate-y-4 pointer-events-none'
        }`}
      >
        <a href="#" className="block py-3 text-blue-300 hover:text-blue-100 hover:pl-2 transition-all duration-200">Home</a>
        <a href="#" className="block py-3 text-gray-300 hover:text-blue-300 hover:pl-2 transition-all duration-200">Services</a>
        <a href="#" className="block py-3 text-gray-300 hover:text-blue-300 hover:pl-2 transition-all duration-200">About</a>
        <a href="#" className="block py-3 text-gray-300 hover:text-blue-300 hover:pl-2 transition-all duration-200">Projects</a>
        <a href="#" className="block py-3 text-gray-300 hover:text-blue-300 hover:pl-2 transition-all duration-200">Contact</a>
      </div>
    </>)
