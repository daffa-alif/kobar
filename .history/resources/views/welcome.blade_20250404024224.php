...
const App = () => {
  ...
  return (
    <div className="relative z-10">
      <nav className={`px-6 py-4 flex justify-between items-center sticky top-0 transition-all duration-300 ${
        scrolled ? 'bg-gray-900 bg-opacity-70 backdrop-blur-md shadow-lg' : ''
      }`}>
      ...
      <div 
        className={`md:hidden bg-gray-800 glass-card mt-2 rounded-lg p-4 mx-4 overflow-hidden transition-all duration-300 ease-in-out ${
          showMenu 
